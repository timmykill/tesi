...
Given $C_1, C_2$ in \textbf{[Chor]} s.t. $\Delta, \Gamma, \bot \vdash C_1$ and $\Delta, \Gamma, \bot \vdash C_2$, given $\Sigma_1, \Sigma_2$ s.t. $\Gamma \vdash \Sigma_1 $ and $\Gamma \vdash \Sigma_2$
