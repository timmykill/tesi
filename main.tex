...
Soundness of the proof ultimately rests on a small \emph{trusted kernel}: a compact type-checker that implements Lean's dependent type theory and accepts only well-typed declarations up to definitional equality.\cite{de2015lean} The compilation step from tactics to  \textbf{TODO: non proprio corretta, vedi come scrivere meglio}
