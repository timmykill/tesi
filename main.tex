	...
	\item \emph{size: n+1} In this case we have two hypothesis:
		...
		\begin{itemize}
			...
			Which can do $n-1$ steps $\tau@p_2, \ldots, \tau@p_n$ and reach
				...
				We now look at $C'$ and notice, by reasoning on the definition of \emph{process substitution} and \emph{sequantial composition} \textbf{TODO: in realtà questo è da dimostrare, ho fatto dimostrazione sketch su carta}:
